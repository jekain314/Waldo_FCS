...
namespace CanonSDK
{
    public struct CameraStats
    {
        /// <summary>
        /// //////////////////////////////////////////////////////
        /// //Camera properties determined at the start of imaging
        /// //////////////////////////////////////////////////////
        /// </summary>
    ...
    public class PhotoStats
    {
        /// <summary>
        /// ///////////////////////////////////////////////////////////////////
        /// // statistics of the image collection process
        /// ///////////////////////////////////////////////////////////////////
        /// </summary>
        public int numberPhotosRequested;
        public int numberPhotosDownloaded;
        public double avgDownloadTime;
        public double avgPhotoSize;
        public double avgTimeToPrefireAck;
        public double avgTimeToFireAck;
        public double avgTimeToFirstVolChanged;
        public double avgTimeToSecondVolChanged;
        public double avgTimeToDirItemTransfer;
        public double AvgTimetToDirItemCreated;
        public PhotoStats()
        {
            numberPhotosRequested       = 0;
            numberPhotosDownloaded      = 0;
            avgDownloadTime             = 0.0;
            avgPhotoSize                = 0.0;
            avgTimeToPrefireAck         = 0.0;
            avgTimeToFireAck            = 0.0;
            avgTimeToFirstVolChanged    = 0.0;
            avgTimeToSecondVolChanged   = 0.0;
            avgTimeToDirItemTransfer    = 0.0;
            AvgTimetToDirItemCreated    = 0.0;
        }
    ...
    {
        public string CanonPhotoNameOnDisk;
        public string PCPhotoNameOnDisk;
        public int currentPhotoNumber;
        public double photoSize;
        //public double prefireAcknowledge;       //filled by the mbed communication
        //public double fireAcknowledge;          //filled by the mbed communication
        public double timeToFirstVolChanged;
        public double timeToSecondVolChanged;
        public double timeToDirItemTransfer;
        public double timeToDirItemCreated;
        public double timeToDownloadComplete;
        ...
        public PhotoParameters()
        {
            ...
            photoSize               = -1.0;
            //prefireAcknowledge      = -1.0;       //filled by the mbed communication
            //fireAcknowledge         = -1.0;          //filled by the mbed communication
            timeToFirstVolChanged   = -1.0;
            timeToSecondVolChanged  = -1.0;
            timeToDirItemTransfer   = -1.0;
            timeToDirItemCreated    = -1.0;
            timeToDownloadComplete  = -1.0;
        }
    }
    ...
    {
        #region Variables used throughout the Camera class
        ...
        String missionPlansFolder;

        int photoNumberThisSession = 0;
        ...
        public uint Error
        {
            ...
            set 
            {
                ...
                {
                    logFile.WriteLine("EDSDK error: " + value.ToString("X"));
        ...
        public void setPhotoSaveDirectory(String photoSaveDirectoryWithPath)
        {
            ImageSaveDirectory = photoSaveDirectoryWithPath;
        ...
        {
            ///////////////////////////////////////////////////////////////////////////////////////////
            //this should be called by the host after a photo is detected to be complete
            //Procedure passes back various parameters related to the Canon photo collection session
            ///////////////////////////////////////////////////////////////////////////////////////////
        ...
        {
            /////////////////////////////////////////////////////////////////////////
            //gets camera Photo statistics
            //works with the CameraStats class.Update procedure to provide averages
            /////////////////////////////////////////////////////////////////////////
            return cameraStats;
        }
        ...
        {
            ///////////////////////////////////////////////////////////////////////////////
            //called by the host to establish the name of the Photo as stored on the PC
            //muts be set before the photo is taken
            ///////////////////////////////////////////////////////////////////////////////
       ...
       /// <summary>
        ...
        #region Camera Event handling (Object, Property, State)
        ...
        private uint Camera_SDKObjectEvent(uint inEvent, IntPtr inRef, IntPtr inContext)
        {
            ...
            switch (inEvent)
            {
                ...
                case EDSDK.ObjectEvent_DirItemCancelTransferDT:
                    logFile.WriteLine(" DirItemCancelTransferDT ");
                    break;
                case EDSDK.ObjectEvent_DirItemContentChanged:
                    logFile.WriteLine(" DirItemContentChanged ");
                    break;
                case EDSDK.ObjectEvent_DirItemCreated:
                    photoParameters.timeToDirItemCreated = (int)photoTimer.ElapsedMilliseconds;
                    //logFile.WriteLine(String.Format("{0} DirItemCreated ", photoTimer.ElapsedMilliseconds));
                    //PhotoDownloadTime = (int)photoTimer.ElapsedMilliseconds;
                    PhotoInProgress = false;
                    break;
                case EDSDK.ObjectEvent_DirItemInfoChanged:
                    logFile.WriteLine(" DirItemInfoChanged ");
                    break;
                case EDSDK.ObjectEvent_DirItemRemoved:
                    logFile.WriteLine(" DirItemRemoved ");
                    break;
                case EDSDK.ObjectEvent_DirItemRequestTransfer:

                    photoParameters.timeToDirItemTransfer = (int)photoTimer.ElapsedMilliseconds;
                    //logFile.WriteLine(String.Format("{0} DirItemRequestTransfer ", photoTimer.ElapsedMilliseconds));

                    DownloadImage(inRef, ImageSaveDirectory);

                    photoParameters.timeToDownloadComplete = (int)photoTimer.ElapsedMilliseconds;
                    photoParameters.currentPhotoNumber = photoNumberThisSession;

                    photoNumberThisSession++;

                    //logFile.WriteLine(String.Format("{0} Download Complete ", PhotoDownloadTime));
                    photoParameters.downloadSuccess = true;
                    //PhotoInProgress = false;
                    break;
                case EDSDK.ObjectEvent_DirItemRequestTransferDT:
                    logFile.WriteLine(" DirItemRequestTransferDT ");
                    break;
                case EDSDK.ObjectEvent_FolderUpdateItems:
                    logFile.WriteLine(" olderUpdateItems ");
                    break;
                case EDSDK.ObjectEvent_VolumeAdded:
                    logFile.WriteLine(" VolumeAdded ");
                    break;
                case EDSDK.ObjectEvent_VolumeInfoChanged:
                    //logFile.WriteLine(String.Format("{0} VolumeInfoChanged ", photoTimer.ElapsedMilliseconds));
                    if (volumeChangedCounter==0) photoParameters.timeToFirstVolChanged = photoTimer.ElapsedMilliseconds;
                    else if (volumeChangedCounter==1) photoParameters.timeToSecondVolChanged = photoTimer.ElapsedMilliseconds;
                    volumeChangedCounter++;
                    break;
                case EDSDK.ObjectEvent_VolumeRemoved:
                    logFile.WriteLine(" VolumeRemoved ");
                    break;
                case EDSDK.ObjectEvent_VolumeUpdateItems:
                    logFile.WriteLine(" VolumeUpdateItems ");
                    break;
            }
        ...
        public void DownloadImage(IntPtr ObjectPointer, string directory)
        {
            ...
            photoParameters.photoSize = dirInfo.Size;

            //file name on the Canon storage media
            CanonPhotoName = dirInfo.szFileName;
            logFile.WriteLine("Downloading Canon photo:  " + CanonPhotoName);

            //photo file name after transfer to PC  -- photoNameWithExtension must be set prio tor the trigger command
            string PCPhotoName = Path.Combine(directory, photoNameWithExtension);
            //logFile.WriteLine(" PC  photo name:  " + PCPhotoName);

            photoParameters.CanonPhotoNameOnDisk = CanonPhotoName;
            photoParameters.PCPhotoNameOnDisk = photoNameWithExtension;  //directory not added

            //create the filestream that will transfer the Canon photo to the PC
            Error = EDSDK.EdsCreateFileStream(PCPhotoName, EDSDK.EdsFileCreateDisposition.CreateAlways, EDSDK.EdsAccess.ReadWrite, out streamRef);      
            
            //transfer the photo file in blocks until done
            uint blockSize = 1024 * 1024;
            //logFile.WriteLine("image size:  " + dirInfo.Size.ToString());
            uint remainingBytes = dirInfo.Size;

            /////////////////////////////////////
            blockSize = dirInfo.Size;
            /////////////////////////////////////
            ...
            do
            {
                ...
                //logFile.WriteLine("downloading block:  " + blockSize.ToString());
                Error = EDSDK.EdsDownload(ObjectPointer, blockSize, streamRef);
            } while (remainingBytes > 512);
            //logFile.WriteLine("completed Download");
        ...
        public void TakePhoto()
        {
            ...
            new Thread(delegate()
            {
                ...
                while (BusyCount < 200)
                {
                    ...
                    if (err == EDSDK.EDS_ERR_DEVICE_BUSY) { BusyCount++; Thread.Sleep(50); }  //sleep 50 millisecs when busy
                    else 
                    {
                        logFile.WriteLine("breaking from CameraCommand_TakePicture on error ");
                        break; 
                    }
                }
                logFile.WriteLine("BusyCount = " + BusyCount.ToString());
